...
\usepackage[a5paper,top=1.10cm, bottom=1.20cm, left = 1.0cm, right=1.0cm]{geometry}
\usepackage{relsize}
...
\vspace*{0.5cm}
\huge
\textbf{Chrzest \\ Michała Jerzego Kontnego}
\vspace{1.0cm}
...
\textcolor{red}{R.} \textcolor{black} Michał Jerzy.\\
\textcolor{red}{K.} \textcolor{black} O co prosicie Kościół Boży dla Michała Jerzego? \\
...
\textcolor{red}{K.} \textcolor{black}{Michale Jerzy wspólnota chrześcijańska przyjmuje cię z wielką radością. W imieniu tej wspólnoty znaczę cię znakiem krzyża. Po mnie wy, rodzice i chrzestni, naznaczcie wasze dziecko znakiem Jezusa Chrystusa, naszego Zbawiciela.}\\
...
\textcolor{red}{1. Czytanie (208)} \\
\textcolor{red}{Psalm (230)} \\ \\
\textcolor{red}{refren} \\ \\
Zbudź się, o śpiący, Chrystus cię oświeci. \\ \\
\textcolor{red}{2. Czytanie (215)} \\
\textcolor{red}{Werset przed Ewangelią (234)} \\
Ja jestem drogą, prawdą i życiem. * nikt nie przychodzi do Ojca inaczej, jak tylko przeze Mnie. \\
\textcolor{red}{Ewangelia (217)}
\begin{center}
\Large
...
ut Satanæ, spíritus nequítiae, a nobis expélleret potestátem,
...
\begin{Parallel}[v]{0.485\textwidth}{0.485\textwidth}
\ParallelLText{
Orémus, fratres dilectissimi, ut Dominus Deus omnipotens novam ex squa et Spiritu Sancto vitam huic pàrvulo largiàtur. \\
\response Amen.
}
\ParallelRText{
\textcolor{black} Módlmy się, aby Bóg wszechmogący obdarzył to dziecko nowym życiem z wody i z Ducha Świętego.. \\
\response Amen.
}
\end{Parallel}
\begin{center}
...
ut iam tunc virtùtem sanctificàndi aquàrum natura conciperet;
...
\begin{center}
\Large
\textcolor{black}{Chrzest}
\end{center}

\textcolor{red}{Celebrans zaprasza rodzinę, aby podeszła do chrzcielnicy, i pyta rodziców i chrzestnych:} \\
\textcolor{red}{K.} Czy chcecie, aby Michał Jerzy otrzymał chrzest w wierze Kościoła, którą przed chwilą wspólnie wyznaliśmy? \\
...
\begin{Parallel}[v]{0.485\textwidth}{0.485\textwidth}
\ParallelLText{
Michael Georgi, ego te baptizo in nòmine Patris,
}
\ParallelRText{
Michale Jerzy, ja ciebie chrzczę w imię Ojca
}
\end{Parallel}
...
\textcolor{red}{Wypada, aby po chrzcie dziecka uczestnicy wypowiadali krótką aklamację:}\\
...
\begin{Parallel}[v]{0.485\textwidth}{0.485\textwidth}
\ParallelLText{
Michael Georgi nova creatura factus es et Christum induisti. Vestís
...
\ParallelRText{
Michale Jerzy, stałeś się nowym stworzeniem i przyoblokłeś się w Chrystusa, dlatego otrzymujesz białą szatę. Niech twoi bliscy słowem i przykładem pomagają ci zachować godność dziecka Bożego, nieskalaną aż po życie wieczne.\\
\response Amen.
}
\end{Parallel}
...
Ecclèsiæ Patrem vocàbit. Nunc nòmine eius, in spiritu adoptiónis
...
\begin{center}
\Large
\noindent\textcolor{black}{Komunia święta}
\end{center}

\textcolor{red}{Wszyscy razem z odmawiają spowiedź powszechną:}

Spowiadam się Bogu Wszechmogącmu i wam bracia i siostry, że bardzo zgrzeszyłem, mową, uczynkiem i zaniedbaniem;
...
ale nas zbaw ode złego. Amen. \\[0.3cm]
Baranku Boży, który gładzisz grzechy świata, zmiłuj się nad nami. \\
Baranku Boży, który gładzisz grzechy świata, zmiłuj się nad nami. \\
Baranku Boży, który gładzisz grzechy świata, obdarz nas pokojem. \\[0.3cm]
\textcolor{red}{Następuje Komunia Święta}
